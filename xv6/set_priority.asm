...
int main(int argc, char *argv[])
{
  ...
  19:	e8 32 02 00 00       	call   250 <atoi>
...
int main(int argc, char *argv[])
{
  ...
  22:	89 c6                	mov    %eax,%esi
	int priority = atoi(argv[2]);
  24:	e8 27 02 00 00       	call   250 <atoi>
	if(priority < 0 || priority > 100)
  29:	83 c4 10             	add    $0x10,%esp
  2c:	83 f8 64             	cmp    $0x64,%eax
  2f:	76 1f                	jbe    50 <main+0x50>
	{
		printf(2,"Invalid Priority\n");
  31:	83 ec 08             	sub    $0x8,%esp
  34:	68 40 07 00 00       	push   $0x740
  39:	6a 02                	push   $0x2
  3b:	e8 e0 03 00 00       	call   420 <printf>
		return 23;
	}
	printf(1,"Priority of Process with pid %d set to %d",pid,priority);
	set_priority(pid,priority);
	exit();
  40:	8d 65 f4             	lea    -0xc(%ebp),%esp
  43:	b8 17 00 00 00       	mov    $0x17,%eax
  48:	59                   	pop    %ecx
  49:	5b                   	pop    %ebx
  4a:	5e                   	pop    %esi
  4b:	5d                   	pop    %ebp
  ...
  66:	50                   	push   %eax
  67:	56                   	push   %esi
  68:	e8 fd 02 00 00       	call   36a <set_priority>
	exit();
...
free(void *ap)
{
 ...
 5c1:	a1 3c 0a 00 00       	mov    0xa3c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 3c 0a 00 00       	mov    %eax,0xa3c
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 3c 0a 00 00       	mov    %eax,0xa3c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	39 05 3c 0a 00 00    	cmp    %eax,0xa3c
 ...
 6d6:	e8 e5 fe ff ff       	call   5c0 <free>
  return freep;
 6db:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 3c 0a 00 00 40 	movl   $0xa40,0xa3c
 71d:	0a 00 00 
 720:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 40 0a 00 00       	mov    $0xa40,%eax
 72f:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 736:	00 00 00 
