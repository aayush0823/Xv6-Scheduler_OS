...
int main(int argc, char *argv[])
{
  17:	8b 41 04             	mov    0x4(%ecx),%eax
    int n;
    if(argc < 2)
  1a:	0f 8e 9c 00 00 00    	jle    bc <main+0xbc>
        n = 1;  // default value
    else
  ...
  2e:	83 f8 64             	cmp    $0x64,%eax
{
  ...
  31:	89 c7                	mov    %eax,%edi
    if(n<0 || n>100)
  33:	0f 86 c1 00 00 00    	jbe    fa <main+0xfa>
        n = 2;
  39:	bf 02 00 00 00       	mov    $0x2,%edi
  3e:	31 db                	xor    %ebx,%ebx
  40:	eb 38                	jmp    7a <main+0x7a>
  ...
  59:	6a 01                	push   $0x1
  5b:	e8 50 04 00 00       	call   4b0 <printf>
            wait();
  60:	e8 f5 02 00 00       	call   35a <wait>
            printf(1,"Demo Process Ends\n");
  65:	59                   	pop    %ecx
  66:	5e                   	pop    %esi
  67:	68 15 08 00 00       	push   $0x815
  6c:	6a 01                	push   $0x1
  ...
  73:	83 c4 10             	add    $0x10,%esp
    ...
    int id = 0;
    for(int k=0; k<n; k++)
  76:	39 fb                	cmp    %edi,%ebx
  78:	7d 2e                	jge    a8 <main+0xa8>
    {
        double x=0;
        id = fork();
  7a:	e8 cb 02 00 00       	call   34a <fork>
        if(id < 0)
  ...
  81:	89 c6                	mov    %eax,%esi
        if(id < 0)
  83:	79 c3                	jns    48 <main+0x48>
            printf(1, "%d failed in fork!\n", getpid());
  85:	e8 48 03 00 00       	call   3d2 <getpid>
  ...
  8d:	83 c3 01             	add    $0x1,%ebx
    {
        ...
        if(id < 0)
            printf(1, "%d failed in fork!\n", getpid());
  90:	50                   	push   %eax
  91:	68 e4 07 00 00       	push   $0x7e4
  96:	6a 01                	push   $0x1
  98:	e8 13 04 00 00       	call   4b0 <printf>
...
int main(int argc, char *argv[])
{
  ...
  c1:	e9 78 ff ff ff       	jmp    3e <main+0x3e>
            wait();
            printf(1,"Demo Process Ends\n");
        }
        else
  ...
  c6:	e8 07 03 00 00       	call   3d2 <getpid>
  cb:	52                   	push   %edx
  cc:	50                   	push   %eax
  ...
  db:	83 c4 10             	add    $0x10,%esp
            for( double z=0;z<1600000.0;z+=0.001)
  de:	dd 05 40 08 00 00    	fldl   0x840
  e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  e8:	dc c1                	fadd   %st,%st(1)
  ea:	d9 05 48 08 00 00    	flds   0x848
  f0:	df ea                	fucomip %st(2),%st
  f2:	77 f4                	ja     e8 <main+0xe8>
  f4:	dd d8                	fstp   %st(0)
  f6:	dd d8                	fstp   %st(0)
  f8:	eb ae                	jmp    a8 <main+0xa8>
        n = atoi(argv[1]);  // from user input
    if(n<0 || n>100)
        n = 2;
  ...
  fc:	74 aa                	je     a8 <main+0xa8>
  fe:	e9 3b ff ff ff       	jmp    3e <main+0x3e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44f:	f7 f6                	div    %esi
 451:	0f b6 92 54 08 00 00 	movzbl 0x854(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5cb:	b8 4c 08 00 00       	mov    $0x84c,%eax
